...
class MultiThreadRasterSample final : public App
{
	...
	static constexpr soul_size ROW_COUNT = 80;
	static constexpr soul_size COL_COUNT = 30;
	...
	soul::Vector<MultithreadRasterPushConstant> push_constants_;

	static void fill_push_constant_vector(soul::Vector<MultithreadRasterPushConstant>& vector,
