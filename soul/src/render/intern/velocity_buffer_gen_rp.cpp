...
namespace Soul {
	...
	void VelocityBufferGenRP::init(RenderDatabase& database) {
	...
	void VelocityBufferGenRP::execute(RenderDatabase& db) {
	...
	void VelocityBufferGenRP::shutdown(RenderDatabase& database) {
