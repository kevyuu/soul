...
namespace Soul {
	namespace Render {
		void PBRSceneRP::init(Database& db) {
			...
			GLuint sceneDataBlockIndex = glGetUniformBlockIndex(sceneShader, Constant::CAMERA_DATA_NAME);
			glUniformBlockBinding(sceneShader, sceneDataBlockIndex, Constant::CAMERA_DATA_BINDING_POINT);

			GLuint lightDataBlockIndex = glGetUniformBlockIndex(sceneShader, Constant::LIGHT_DATA_NAME);
			glUniformBlockBinding(sceneShader, lightDataBlockIndex, Constant::LIGHT_DATA_BINDING_POINT);
		...
		void PBRSceneRP::execute(Database &database) {
		...
		void PBRSceneRP::shutdown(Database &database) {
