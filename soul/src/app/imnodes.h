...
namespace IMNODES_NAMESPACE
{
  ...
  // to anything. However, you can still use IsAttributeActive() and IsAnyAttributeActive() to check
  // for attribute activity.
  ...
  // Assigns the id of the UI element being hovered over to the function argument. Use these
  // functions after EndNodeEditor() has been called.
  ...
  const char* SaveEditorStateToIniString(
    const ImNodesEditorContext* editor, size_t* data_size = NULL);

  void LoadCurrentEditorStateFromIniString(const char* data, size_t data_size);
  void LoadEditorStateFromIniString(
    ImNodesEditorContext* editor, const char* data, size_t data_size);
