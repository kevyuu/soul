...
namespace soul
{
  ...
  auto Copy(InputIt first, InputIt last, OutputIt output) -> void
  {
  ...
  auto Move(ElemType* begin, ElemType* end, ElemType* dst) -> void
  {
    memcpy(
      static_cast<void*>(dst),
      static_cast<void*>(begin),
      static_cast<uint64>(end - begin) * sizeof(ElemType)); // NOLINT(bugprone-sizeof-expression)
  }
  ...
  auto Destruct(ElemType* begin, ElemType* end) -> void
  {
  }
