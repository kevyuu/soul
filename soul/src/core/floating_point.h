...
namespace soul
{
  struct Float16 {
    ...
    explicit operator float() const { return Float16BitToFloat32(bits_); }

    auto operator==(const Float16 other) const -> bool { return bits_ == other.bits_; }
    ...
    auto operator+() const -> Float16 { return *this; }

    auto operator-() const -> Float16 { return std::bit_cast<Float16, bit_type>(bits_ ^ 0x8000); }
    ...
    auto operator+=(const Float16 other) -> Float16 { return *this = *this + other; }
  ...
  {
    inline auto operator""_f16(long double value) -> f16 { return f16(static_cast<float>(value)); }
    inline auto operator""_f32(long double value) -> f32 { return static_cast<f32>(value); }
    inline auto operator""_f64(long double value) -> f64 { return static_cast<f64>(value); }
  } // namespace literal
