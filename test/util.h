...
#define SOUL_TEST_ASSERT_GE(expr1, expr2) ASSERT_GE(expr1, expr2) << "Case : " << get_soul_test_message()
#define SOUL_TEST_ASSERT_GT(expr1, expr2) ASSERT_GT(expr1, expr2) << "Case : " << get_soul_test_message()
#define SOUL_TEST_ASSERT_LE(expr1, expr2) ASSERT_LE(expr1, expr2) << "Case : " << get_soul_test_message()
