...
std::vector<bool> generate_random_bool_vector(const soul_size size)
{
...
std::vector<bool> get_vector_from_bit_vector(const soul::BitVector<T> bit_vector)
{
    std::vector<bool> result;
...
void verify_sequence(const soul::BitVector<BlockType>& bit_vector, const std::vector<bool>& src_vector)
{
...
template <soul::bit_block_type BlockType>
void test_constructor_with_init_desc(const soul::BitVectorInitDesc init_desc)
{
...
{
    const soul::BitVector<> bit_vector({ .size = 10, .val = false, .capacity = 12 }, * soul::get_default_allocator() );
...
template <soul::bit_block_type BlockType>
void test_constructor_with_size(soul_size size)
{
...
template <soul::bit_block_type BlockType>
void test_constructor_with_size_and_value(const soul_size size, const bool val)
{
...
template<soul::bit_block_type BlockType>
void test_constructor_with_bool_iterator(const soul_size size)
{
...
template<soul::bit_block_type BlockType>
void test_copy_constructor(const soul_size size)
{
    const std::vector<bool> random_bool_vec = generate_random_bool_vector(size);
...
template<soul::bit_block_type BlockType>
void test_move_constructor(const soul_size size)
{
    const std::vector<bool> random_bool_vec = generate_random_bool_vector(size);
...
public:
    ...
    TestBitVectorManipulation() :
        ...
        u64_filled_bit_vector({.size = RANDOM_BOOL_VECTOR_SIZE, .val = true, .capacity = TEST_CAPACITY }) {}
...
{
    auto test_resize = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size size) {
...
{
    auto test_reserve = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size new_capacity) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
...
{
    auto test_push_back = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const bool val) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
    ...
    auto test_push_back_with_val = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const bool val) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
...
TEST_F(TestBitVectorManipulation, TestBitVectorPopBack)
{
    ...
    auto test_pop_back_with_count = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size size) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
        for (soul_size i = 0; i < size; ++i)
        {
            expected_vector.pop_back();
...
{
    auto test_set_with_index = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size index, const bool val) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
    ...
    SOUL_TEST_RUN(test_set_with_index(u8_filled_bit_vector, u8_filled_bit_vector.capacity() + 10, false));
    SOUL_TEST_RUN(test_set_with_index(u8_filled_bit_vector, u8_filled_bit_vector.capacity() + 10, true));

    SOUL_TEST_RUN(test_set_with_index(u32_filled_bit_vector, 5, true));
    SOUL_TEST_RUN(test_set_with_index(u32_filled_bit_vector, u32_filled_bit_vector.capacity() + 10, false));
    SOUL_TEST_RUN(test_set_with_index(u32_filled_bit_vector, u32_filled_bit_vector.capacity() + 10, true));

    SOUL_TEST_RUN(test_set_with_index(u64_filled_bit_vector, 5, true));
    SOUL_TEST_RUN(test_set_with_index(u64_filled_bit_vector, u64_filled_bit_vector.capacity() + 10, false));
    SOUL_TEST_RUN(test_set_with_index(u64_filled_bit_vector, u64_filled_bit_vector.capacity() + 10, true));
...
{
    auto test_bit_ref_and = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size idx, const bool val) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
    ...
    auto test_bit_ref_or = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size idx, const bool val) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
        expected_vector[idx] = expected_vector[idx] || val;
        bit_vector[idx] |= val;
        verify_sequence(bit_vector, expected_vector);
    ...
    auto test_bit_ref_xor = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size idx, const bool val) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
        expected_vector[idx] = (expected_vector[idx] != val);
        bit_vector[idx] ^= val;
        verify_sequence(bit_vector, expected_vector);
    ...
    auto test_bit_flip = []<soul::bit_block_type BlockType>(soul::BitVector<BlockType> bit_vector, const soul_size idx) {
        auto expected_vector = get_vector_from_bit_vector(bit_vector);
